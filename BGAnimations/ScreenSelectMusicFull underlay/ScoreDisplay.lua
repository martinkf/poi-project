...
for pn in ivalues(GAMESTATE:GetHumanPlayers()) do
	t[#t+1] = Def.ActorFrame {
		...
		RefreshCommand=function(self)
			...
			-- logic for top 6 "personal records"
		...
		Def.ActorFrame { Name="PersonalRecords_module",
			...
			Def.ActorFrame { Name="PersonalRecordsGroup_4",
				InitCommand=function(self)
					self:y(212)
					self:visible(false)
				end,
			...
			Def.ActorFrame { Name="PersonalRecordsGroup_5",
				InitCommand=function(self)
					self:y(266)
					self:visible(false)
				end,
			...
			Def.ActorFrame { Name="PersonalRecordsGroup_6",
				InitCommand=function(self)
					self:y(320)
					self:visible(false)
				end,
